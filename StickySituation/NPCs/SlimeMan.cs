...
namespace StickySituation.NPCs            //We need this to basically indicate the folder where it is to be read from, so you the texture will load correctly
{ 
    /*
    public class SlimeMan : ModNPC
    {
        ...
        {
            //npc.name = "Gello";   //the name displayed when hovering over the npc ingame.
            ...
            npc.defense = 30;  //the npc defense
            npc.lifeMax = 251;// the npc life
        ...
        public override void SetupShop(Chest shop, ref int nextSlot)       //Allows you to add items to this town NPC's shop. Add an item by setting the defaults of shop.item[nextSlot] then incrementing nextSlot.
        {
            ...
            if (NPC.downedBoss3)   //this make so when Skeletron is killed the town npc will sell this
            {
                ...
                nextSlot++;
                shop.item[nextSlot].SetDefaults(mod.ItemType("GelBow"));
                nextSlot++;
                shop.item[nextSlot].SetDefaults(mod.ItemType("GelJavelin"));
                nextSlot++;
                shop.item[nextSlot].SetDefaults(mod.ItemType("GelSword"));
                nextSlot++;
            ...
            nextSlot++;
            shop.item[nextSlot].SetDefaults(mod.ItemType("GelCoatedArrow"));  //this is an example of how to add a modded item
            nextSlot++;
        ...
        public override string GetChat()       //Allows you to give this town NPC a chat message when a player talks to it.
        {
            ...
            {
                return "" + Main.npc[wizardNPC].GivenName + ", keeps trying to add magic to gel.";
            }
            ...
            {
                return "Sure you can ask " + Main.npc[guideNPC].GivenName + " how to make gel coated arrows, or just buy some.";
            }
            switch (Main.rand.Next(4))    //this are the messages when you talk to the npc
            {
                ...
                case 2:
                    return "Don't waste my time if you're not going to buy something.";
                case 3:
                    return "Don't let anything stick to your hands.";
                default:
        ...
        {
            damage = 65;  //npc damage
            knockback = 4f;   //npc knockback
        }
        ...
        {
            scale = 1f;
            item = Main.itemTexture[mod.ItemType("GelBow")]; //this defines the item that this npc will use
            itemSize = 56;
        }
